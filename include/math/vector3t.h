...
struct Vector3T
{
     ...
     */
    constexpr explicit Vector3T(T value);
     ...
     */
    constexpr Vector3T(T xx, T yy, T zz);
    ...
    template <typename U>
    Vector3T operator*(U scalar) const;
    template <typename U>
    Vector3T& operator*=(U scalar);
    template <typename U>
    Vector3T operator/(U scalar) const;
    template <typename U>
    Vector3T& operator/=(U scalar);
...
Vector3T<T> operator*(U scalar, const Vector3T<T>& vec);
 ...
 */
template <typename T>
[[nodiscard]] bool ContainsNonFinite(const Vector3T<T>& vec);
 ...
 */
template <typename T>
[[nodiscard]] bool ContainsNaN(const Vector3T<T>& vec);
 ...
 */
template <typename T>
[[nodiscard]] Vector3T<T> Abs(const Vector3T<T>& vec);
 ...
 */
template <typename T>
[[nodiscard]] T LengthSquared(const Vector3T<T>& vec);
 ...
 */
template <typename T>
[[nodiscard]] double Length(const Vector3T<T>& vec);
 ...
 */
template <typename T>
bool IsEqual(const Vector3T<T>& vec1, const Vector3T<T>& vec2, T epsilon);
 ...
 */
template <typename T>
T Dot(const Vector3T<T>& vec1, const Vector3T<T>& vec2);
 ...
 */
template <typename T>
T AbsDot(const Vector3T<T>& vec1, const Vector3T<T>& vec2);
 ...
 */
template <typename T>
Vector3T<T> Cross(const Vector3T<T>& vec1, const Vector3T<T>& vec2);
 ...
 */
template <typename T>
T Cross2D(const Vector3T<T>& vec1, const Vector3T<T>& vec2);
 ...
 */
template <typename T>
Vector3T<T> Normalize(const Vector3T<T>& vec);
 ...
 */
template <typename T>
Vector3T<T> Min(const Vector3T<T>& vec1, const Vector3T<T>& vec2);
 ...
 */
template <typename T>
Vector3T<T> Max(const Vector3T<T>& vec1, const Vector3T<T>& vec2);
 ...
 */
template <typename T>
Vector3T<T> Permute(const Vector3T<T>& vec, int x, int y, int z);
 ...
 */
template <typename T>
Vector3T<T> Clamp(const Vector3T<T>& vec, T low, T high);
 ...
 */
template <typename T>
Vector3T<T> Reflect(const Vector3T<T>& incidence, const Vector3T<T>& normal);
 ...
 */
template <typename T>
T MinComponent(const Vector3T<T>& vec);
 ...
 */
template <typename T>
T MaxComponent(const Vector3T<T>& vec);
 ...
 */
template <typename T>
int MinDimension(const Vector3T<T>& vec);
 ...
 */
template <typename T>
int MaxDimension(const Vector3T<T>& vec);
...
template <typename T>
constexpr Math::Vector3T<T>::Vector3T()
{
    // No initialization
}

template <typename T>
constexpr Math::Vector3T<T>::Vector3T(T value) : x(value), y(value), z(value)
{
}

template <typename T>
constexpr Math::Vector3T<T>::Vector3T(T xx, T yy, T zz) : x(xx), y(yy), z(zz)
{
}

template <typename T>
T& Math::Vector3T<T>::operator[](int index)
{
    return data[index];
}

template <typename T>
const T& Math::Vector3T<T>::operator[](int index) const
{
    return data[index];
}

template <typename T>
bool Math::Vector3T<T>::operator==(const Vector3T& other) const
{
...
template <typename T>
Math::Vector3T<T> Math::Vector3T<T>::operator+(const Vector3T& other) const
{
    return {x + other.x, y + other.y, z + other.z};
}

template <typename T>
Math::Vector3T<T>& Math::Vector3T<T>::operator+=(const Vector3T& other)
{
    x += other.x;
    y += other.y;
    z += other.z;
...
template <typename T, typename U>
Math::Vector3T<T> Math::operator*(U scalar, const Vector3T<T>& vec)
{
    return vec * scalar;
}
...
template <typename T>
Math::Vector3T<T> Math::Vector3T<T>::operator-() const
{
    return {-x, -y, -z};
}
...
template <typename T>
template <typename U>
Math::Vector3T<T> Math::Vector3T<T>::operator*(U scalar) const
{
...
template <typename T>
template <typename U>
Math::Vector3T<T>& Math::Vector3T<T>::operator*=(U scalar)
{
    T sc = static_cast<T>(scalar);
    x *= sc;
    y *= sc;
...
template <typename T>
bool Math::ContainsNonFinite(const Vector3T<T>& vec)
{
    return !math::IsFinite(vec.x) || !math::IsFinite(vec.y) || !math::IsFinite(vec.z);
}

template <typename T>
bool Math::ContainsNaN(const Vector3T<T>& vec)
{
    return math::IsNaN(vec.x) || math::IsNaN(vec.y) || math::IsNaN(vec.z);
}

template <typename T>
Math::Vector3T<T> Math::Abs(const Vector3T<T>& vec)
{
    return {math::Abs(vec.x), math::Abs(vec.y), math::Abs(vec.z)};
}

template <typename T>
T Math::LengthSquared(const Vector3T<T>& vec)
{
    return vec.x * vec.x + vec.y * vec.y + vec.z * vec.z;
}

template <typename T>
double Math::Length(const Vector3T<T>& vec)
{
    return math::Sqrt(static_cast<double>(LengthSquared(vec)));
}

template <typename T>
bool Math::IsEqual(const Vector3T<T>& vec1, const Vector3T<T>& vec2, T epsilon)
{
...
template <typename T>
T Math::Dot(const Vector3T<T>& vec1, const Vector3T<T>& vec2)
{
    return vec1.x * vec2.x + vec1.y * vec2.y + vec1.z * vec2.z;
}

template <typename T>
T Math::AbsDot(const Vector3T<T>& vec1, const Vector3T<T>& vec2)
{
    return math::Abs(Dot(vec1, vec2));
}

template <typename T>
Math::Vector3T<T> Math::Cross(const Vector3T<T>& vec1, const Vector3T<T>& vec2)
{
...
template <typename T>
T Math::Cross2D(const Vector3T<T>& vec1, const Vector3T<T>& vec2)
{
    return vec1.x * vec2.y - vec1.y * vec2.x;
}

template <typename T>
Math::Vector3T<T> Math::Normalize(const Vector3T<T>& vec)
{
...
template <typename T>
Math::Vector3T<T> Math::Min(const Vector3T<T>& vec1, const Vector3T<T>& vec2)
{
    return {math::Min(vec1.x, vec2.x), math::Min(vec1.y, vec2.y), math::Min(vec1.z, vec2.z)};
}

template <typename T>
Math::Vector3T<T> Math::Max(const Vector3T<T>& vec1, const Vector3T<T>& vec2)
{
    return {math::Max(vec1.x, vec2.x), math::Max(vec1.y, vec2.y), math::Max(vec1.z, vec2.z)};
}

template <typename T>
Math::Vector3T<T> Math::Permute(const Vector3T<T>& vec, int x, int y, int z)
{
    return {vec[x], vec[y], vec[z]};
}

template <typename T>
Math::Vector3T<T> Math::Clamp(const Vector3T<T>& vec, T low, T high)
{
...
template <typename T>
T Math::MinComponent(const Vector3T<T>& vec)
{
    return math::Min(math::Min(vec.x, vec.y), vec.z);
}

template <typename T>
T Math::MaxComponent(const Vector3T<T>& vec)
{
    return math::Max(math::Max(vec.x, vec.y), vec.z);
}

template <typename T>
int Math::MinDimension(const Vector3T<T>& vec)
{
    return vec.x < vec.y ? (vec.x < vec.z ? 0 : 2) : (vec.y < vec.z ? 1 : 2);
}

template <typename T>
int Math::MaxDimension(const Vector3T<T>& vec)
{
    return vec.x > vec.y ? (vec.x > vec.z ? 0 : 2) : (vec.y > vec.z ? 1 : 2);
}

template <typename T>
Math::Vector3T<T> Math::Reflect(const Vector3T<T>& incidence, const Vector3T<T>& normal)
{
