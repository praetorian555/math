...
static constexpr float kInVec2Pi = 0.15915494309189533577f;
...
static constexpr float kLargestFloat = 3.4028234664e38f;
static constexpr float kSmallestFloat = -3.4028234664e38f;
