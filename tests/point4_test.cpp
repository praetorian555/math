...
TEST(Point4Tests, GettersSettersConstruction)
{
...

    {
        ...
        EXPECT_FLOAT_EQ(p.Data[3], 30.0f);
    }
...
TEST(Point4Tests, Euclidian)
{
    ...
    EXPECT_FLOAT_EQ(p2.X, 5.0f);
    EXPECT_FLOAT_EQ(p2.Y, -5.0f);
    EXPECT_FLOAT_EQ(p2.Z, -10.0f);
