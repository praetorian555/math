...
TEST(Vector4Tests, GettersSettersConstruction)
{
...

    {
        ...
        math::Max(vec.B, 20.0f);
        math::Max(vec.A, 25.0f);
    }

    {
        ...
        vec.Z = 50.0f;
        math::Max(vec.Data[2], 50.0f);
        vec.W = 75.0f;
        math::Max(vec.Data[3], 75.0f);
        vec.Set(15.0f, 0);
        math::Max(vec[0], 15.0f);
        vec.Set(20.0f, 1);
        math::Max(vec[1], 20.0f);
        vec.Set(55.0f, 2);
        math::Max(vec[2], 55.0f);
        vec.Set(70.0f, 3);
        math::Max(vec[3], 70.0f);
    }

    {
        Vector2f vec2(10, 15);
        Vector4f vec4(vec2, 20, 25);
        EXPECT_REAL_EQ(vec4.X, 10);
        EXPECT_REAL_EQ(vec4.Y, 15);
        EXPECT_REAL_EQ(vec4.Z, 20);
        EXPECT_REAL_EQ(vec4.W, 25);
    }
...
TEST(Vector4Tests, ToVector2)
{
    ...
    EXPECT_REAL_EQ(v3.X, 10);
    EXPECT_REAL_EQ(v3.Y, 25);
    EXPECT_REAL_EQ(v4.X, 15);
    EXPECT_REAL_EQ(v4.Y, 20);
    EXPECT_REAL_EQ(v5.X, 15);
    EXPECT_REAL_EQ(v5.Y, 25);
    EXPECT_REAL_EQ(v6.X, 20);
    EXPECT_REAL_EQ(v6.Y, 25);
}
...
TEST(Vector4Tests, ToVector3)
{
    ...
    EXPECT_REAL_EQ(v1.X, 10);
    EXPECT_REAL_EQ(v1.Y, 15);
    EXPECT_REAL_EQ(v1.Z, 20);
    EXPECT_REAL_EQ(v2.X, 10);
    EXPECT_REAL_EQ(v2.Y, 15);
    EXPECT_REAL_EQ(v2.Z, 25);
    EXPECT_REAL_EQ(v3.X, 10);
    EXPECT_REAL_EQ(v3.Y, 20);
    EXPECT_REAL_EQ(v3.Z, 25);
    EXPECT_REAL_EQ(v4.X, 15);
    EXPECT_REAL_EQ(v4.Y, 20);
    EXPECT_REAL_EQ(v4.Z, 25);
}
...
TEST(Vector4Tests, Length)
{
    ...
    EXPECT_REAL_EQ(v1.Length(), std::sqrtf(86));
    EXPECT_REAL_EQ(v1.LengthSquared(), 86);
}
...
TEST(Vector4Tests, Dot)
{
    ...
    EXPECT_REAL_EQ(Dot(vec1, vec2), 50.0f);
    EXPECT_REAL_EQ(AbsDot(vec1, vec3), 50.0f);
}
